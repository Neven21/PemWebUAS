        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item" style="padding-left:5px; padding-right:5px;">
                    <a class="nav-link" href="/adminhome">Menu</a>
                </li>
                <li class="nav-item" style="padding-left:5px; padding-right:5px;">
                ...
                <li class="nav-item" style="padding-left:5px; padding-right:5px; border-bottom: 2px solid #a98e68;">
                    <a class="nav-link" style="color: #a98e68;" href="/graphlist">Show Graph</a>
                </li>
            </ul>
            ...
            @if ($userorder->isEmpty())
                <div class="row text-center">  
                    <div class="col-sm-5 fadeIn first m-auto" id="formFooter">
                        <h1 class="card-title"><b>You don't have any orders yet.</b></h1>
                    </div>
                </div>
            @else
                <div id="containerGraph" class="containerGraph"></div>
            @endif
        </div>
    </div>
