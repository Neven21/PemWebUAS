...
<body class="bg">
    ...
    <div class="full-height mx-auto" style="width:50%;">
        <div class="row text-center" style="padding-top:50px;">
            ...
            <div class="col-md-8">
                <div>
                    <h1 class="text-center" style="color:#f1eedb; font-size:50px;"><b>{{$userdata['firstname']}} {{$userdata['lastname']}}</b></h1>
                    <h1 class="text-center" style="color:#f1eedb; font-size:46px;">{{$userdata['email']}}</h1>
                    <h1 class="text-center" style="color:#f1eedb; font-size:28px;">{{$userdata['dob']}}</h1>
                </div>
            </div>
        </div>
    </div>
